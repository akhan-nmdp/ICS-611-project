...
@TestPropertySource(properties = {
        ...
        "amazon.aws.accesskey=myAWSAccessKey1",
        "amazon.aws.secretkey=myAWSAccessSecret1" })
public class ProductInfoRepositoryIntegrationTest {
    ...
    public static void setupClass() {
        ...
        amazonDynamoDB = new AmazonDynamoDBClient(new BasicAWSCredentials("myAWSAccessKey1", "myAWSAccessSecret1"));
