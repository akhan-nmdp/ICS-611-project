...
- [Java – Powerful Comparison with Lambdas](https://www.baeldung.com/java-8-sort-lambda)
...
- [The Double Colon Operator in Java](https://www.baeldung.com/java-8-double-colon-operator)
