...
- [Spring Security – OAuth2 Login](https://www.baeldung.com/spring-security-5-oauth2-login)
...
- [Customizing Authorization and Token Requests with Spring Security Client](https://www.baeldung.com/spring-security-custom-oauth-requests)
